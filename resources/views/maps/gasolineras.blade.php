...
<!--<span class="glyphicon glyphicon-map-marker"></span>-->
                    <div class="row">                        
                        ...
                        <a href="{!!URL::to('/')!!}" type="button" class="btn btn-success">Nueva Busquedad</a>
                          <h4 class="center">GASOLNERAS CERCANAS</h4>
                                          ...
                                          <li>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-xs-2"><img src="/img/icons/farmacia.png" class="profile-img pull-left"></div>
                                                ...
                                                <div class="col-sm-10 col-md-10 col-xs-10">
                                                    <div><span class="text-black">{{$datos->nombreSucursal}}</span>
                                                    </div>
                                                    <div class="">
                                            ...
                                            <input type="button" class="btn btn-primary btn-sm pull-right" value="ver" onClick="funcionClick({{$datos->latitud}},{{$datos->longitud}},'{{$datos->nombreSucursal}}','{{$datos->telefono}}','{{$datos->direccion}}')">
                        ...
                        <div class="col-sm-6 col-md-7 col-xs-6">
                                <div id='map-index' style="width: 850px; height:520px"></div> 
                        </div>
                    </div>           
  ...
  {!!Html::script('dist/js/parroquias.js')!!}
   ...
   <script>
      function initialize() {
        ...
        var markers = [];
            @foreach($gasolineras as $farmas)               

          var latLng = new google.maps.LatLng({{$farmas->latitud}},
              {{$farmas->longitud}});
          var marker = new google.maps.Marker({
            position: latLng,
            icon: '/img/icons/gasolinera.png',
...
var g2LatLon = new google.maps.LatLng(lati, long);
      ...
      var config = {
          ...
          animation: google.maps.Animation.DROP
           ...
           var gMarkerDV = new google.maps.Marker(config);
              gMarkerDV.setIcon('/img/icons/gasolinera.png')
    ...
    @else
      <div class="alert alert-info">
          ...
          <strong>AVISO!!</strong><br>No existen GASOLINERAS Registradas en el lugar que usted Busca hasta el momento. Por favor busque en otra localización 
      </div>
  @endif

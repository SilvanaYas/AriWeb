...
@section('content')
                    ...
                    <div class="row">                        
                        ...
                        <a href="{!!URL::to('/')!!}" type="button" class="btn btn-success">Nueva Busquedad</a>
                          <h4 class="center">BANCOS CERCANAS</h4>
...
var g2LatLon = new google.maps.LatLng(lati, long);
    ...
    @else
      <div class="alert alert-info">
          ...
          <strong>AVISO!!</strong><br>No existen BANCOS Registradas en el lugar que usted Busca hasta el momento. Por favor busque en otra localización 
      </div>
  @endif

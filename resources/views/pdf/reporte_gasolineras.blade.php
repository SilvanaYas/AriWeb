...
<html lang="en">
  <head>
    ...
    <title>Reporte Gasolineras</title>
  ...
  <footer>
    ...
    <main>
    <strong class="blue">Reporte:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="date">Gasolineras Registradas</span><br>
    ...
    <strong class="blue">Fecha Reporte:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="date">{{ $date }}</span><br><br><br>
        ...
        <table class="datatable table table-striped" cellspacing="0" width="100%">
          ...
          <strong class="blue">Número total de Gasolineras:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="number">{{ count($gasolineras) }}</span><br>

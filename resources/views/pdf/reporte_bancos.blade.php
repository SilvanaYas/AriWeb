...
<html lang="en">
  ...
  <footer>
    ...
    <main>
    <strong class="blue">Reporte:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="date">Bancos Registradas</span><br>
    ...
    <strong class="blue">Fecha Reporte:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="date">{{ $date }}</span><br><br><br>
        ...
        <table class="datatable table table-striped" cellspacing="0" width="100%">
          ...
          <strong class="blue">Número total de Bancos:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="number">{{ count($bancos) }}</span><br>

...
<html lang="en">
  <head>
    ...
    <title> Reporte Operadores Económicos</title>
  ...
  <footer>
    <table>
      <tr>
        <td>
            <p class="izq blue">
              Lista de Operadores Económicos
            </p>
        </td>
        <td>
          <p class="page">
    ...
    <main>
    <strong class="blue">Reporte:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="date">Listado de Operadores Económicos</span><br>

...
@section('title', 'Bancos registrados')
@section('content')
                        ...
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="title">Lista de Bancos Registrados</div>
                                    </div>
                                    <div class="btn-group pull-right">
                                         <button data-toggle="dropdown" class="btn btn-primary btn dropdown-toggle">Opciones <span class="caret"></span></button>
                                         <ul class="dropdown-menu">
                                            <li><a href="/reporteBancos/1" target="_blank"><i class="fa fa-file-pdf-o red"></i>Visualizar Reporte</a></li>
                                                <li class="divider"></li>
                                            <li><a href="/reporteBancos/2"><i class="glyphicon glyphicon-download green"></i>Descarga Reporte</a></li>
                                         </ul>
                                      </div>
                                </div>
                                <div class="card-body">
